...
# 获取最可疑区域轮廓点集
tic = time.time()
img = cv2.imread(r'E:\plate_recognition\license-plate-recoginition-main\test_images\6.jpg')



# points = np.array([[156,497], [387,420], [385,486], [156,575]])

# bbox [143,406]  [390,588]   w = 247  h = 182

# img = img[406:588, 143:390, :]
